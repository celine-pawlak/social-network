<?php if(!isset($_SESSION['login']) || empty($_SESSION['login'])){ ?>
    <div class="row container">
        <form id="form_inscription" class="col s6 offset-s3 card formulaire">
            <div class="row">
            ...
            <div class="flex-column">
                ...
                <p class="col s8 offset-s5 ">Déjà inscrit ? <span id="page_connexion" class="clickable">Cliquez Ici</span></p>
            </div>
        </form>
    </div>
<?php } else{
