<div class="cover_img">
  <img src="<?= URL. "ressources/img/". $userInformations['picture_cover'] ?>" alt="Photo de couverture" id="cover_picture">
</div>
...
<div class="container" id="seeProfil">
  <div class="center-align">
    ...
    <img src="<?= URL."ressources/img/". $userInformations['picture_profil'] ?>" alt="Photo de profil" class="profile_img circle">
  </div>
